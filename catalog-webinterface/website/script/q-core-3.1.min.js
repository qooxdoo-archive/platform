...
(function(){var a="qx.bom.client.Xml.getSelectSingleNode",b="qx.bom.client.Stylesheet.getInsertRule",c="qx.bom.client.Html.getDataset",d="qx.bom.client.PhoneGap.getPhoneGap",e="qx.bom.client.EcmaScript.getArrayReduce",f="qx.core.Environment for a list of predefined keys.",g='] found, and no default ("default") given',h="qx.bom.client.Html.getAudioAif",j="qx.bom.client.CssTransform.get3D",k="qx.bom.client.EcmaScript.getArrayLastIndexOf",l=" is not a valid key. Please see the API-doc of ",m=' type)',n="qx.bom.client.EcmaScript.getArrayForEach",o="qx.bom.client.Xml.getAttributeNS",p="qx.bom.client.Stylesheet.getRemoveImport",q="qx.bom.client.Css.getUserModify",r="qx.bom.client.Css.getBoxShadow",s="qx.bom.client.Html.getXul",t="qx.bom.client.Plugin.getWindowsMedia",u=":",v="qx.blankpage",w="The environment key 'json' is deprecated ",x="qx.bom.client.Html.getVideo",y="qx.bom.client.Device.getName",z="qx.bom.client.Event.getTouch",A="qx.optimization.strings",B="qx.debug.property.level",C="qx.bom.client.EcmaScript.getArrayFilter",D="qx.bom.client.EcmaScript.getStringTrim",E="qx.optimization.variables",F="qx.bom.client.EcmaScript.getStackTrace",G="qx.bom.client.EcmaScript.getDateNow",H="qx.bom.client.EcmaScript.getArrayEvery",I="qx.bom.client.Xml.getImplementation",J="qx.bom.client.Html.getConsole",K="qx.bom.client.Engine.getVersion",L="qx.bom.client.Device.getType",M="qx.bom.client.Plugin.getQuicktime",N="qx.bom.client.Html.getNaturalDimensions",O="qx.bom.client.Xml.getSelectNodes",P="qx.bom.client.Xml.getElementsByTagNameNS",Q="qx.nativeScrollBars",R="qx.bom.client.Html.getDataUrl",S="qx.bom.client.Flash.isAvailable",T="qx.bom.client.Html.getCanvas",U="qx.dyntheme",V="qx.bom.client.Device.getPixelRatio",W="qx.bom.client.Css.getBoxModel",X="qx.bom.client.Plugin.getSilverlight",Y="qx/static/blank.html",eo="qx.bom.client.EcmaScript.getArrayMap",ek="qx.bom.client.Css.getUserSelect",ep="qx.bom.client.Css.getRadialGradient",el="json",em="module.property",ej="qx.bom.client.Plugin.getWindowsMediaVersion",en="qx.bom.client.Stylesheet.getCreateStyleSheet",eu='No match for variant "',ev="qx.bom.client.Locale.getLocale",ew="module.events",ex="qx.bom.client.Plugin.getSkype",eq="module.databinding",er="qx.bom.client.Html.getFileReader",es="qx.bom.client.Css.getBorderImage",et="qx.bom.client.Stylesheet.getDeleteRule",eB="qx.bom.client.EcmaScript.getErrorToString",fe="qx.bom.client.Plugin.getDivXVersion",eC="qx.bom.client.Scroll.scrollBarOverlayed",eD="qx.bom.client.Plugin.getPdfVersion",ey="qx.bom.client.Xml.getCreateNode",ez="qx.bom.client.Css.getAlphaImageLoaderNeeded",gf="qx.bom.client.Css.getLinearGradient",eA="qx.bom.client.Transport.getXmlHttpRequest",eE="qx.bom.client.Css.getBorderImageSyntax",eF="qx.bom.client.Html.getClassList",eG="qx.bom.client.Event.getHelp",eL="qx.optimization.comments",eM="qx.bom.client.Locale.getVariant",eN="qx.bom.client.Css.getBoxSizing",eH="qx.bom.client.OperatingSystem.getName",eI="module.logger",eJ="qx.mobile.emulatetouch",eK="qx.bom.client.Html.getAudioWav",eR="qx.bom.client.Browser.getName",eS="qx.bom.client.Css.getInlineBlock",eT="qx.bom.client.Plugin.getPdf",eU="please use 'css.pointerevents' instead.",eO="qx.dynlocale",eP="qx.bom.client.Device.getTouch",gg="The environment key 'event.pointer' is deprecated, ",eQ="qx.emulatemouse",eY='" (',fa="qx.bom.client.Html.getAudio",gk="qx.core.Environment",fb="qx.bom.client.EcmaScript.getFunctionBind",eV="qx.bom.client.CssTransform.getSupport",eW="qx.bom.client.Html.getTextContent",gi="qx.bom.client.Css.getPlaceholder",eX="qx.bom.client.Css.getFloat",fc="default",fd=' in variants [',fp="false",fo="qx.bom.client.Css.getFilterGradient",fn="qx.bom.client.Html.getHistoryState",ft="qxenv",fs="qx.bom.client.Html.getSessionStorage",fr="qx.bom.client.Html.getAudioAu",fq="qx.bom.client.Css.getOpacity",fi="qx.bom.client.Css.getFilterTextShadow",fh="qx.bom.client.Html.getVml",fg="qx.bom.client.Transport.getMaxConcurrentRequestCount",ff="qx.bom.client.Event.getHashChange",fm="qx.bom.client.Css.getRgba",fl="qx.debug.dispose",fk="qx.bom.client.Css.getBorderRadius",fj="qx.bom.client.EcmaScript.getArraySome",fA="qx.bom.client.Transport.getSsl",fz="qx.bom.client.Html.getWebWorker",fy="qx.bom.client.Json.getJson",fx="qx.bom.client.Browser.getQuirksMode",fE="and will eventually be removed.",fD="qx.bom.client.Css.getTextOverflow",fC="qx.bom.client.EcmaScript.getArrayIndexOf",fB="qx.bom.client.Xml.getQualifiedItem",fw="qx.bom.client.Html.getVideoOgg",fv="&",fu="qx.bom.client.EcmaScript.getArrayReduceRight",fP="qx.bom.client.Engine.getMsPointer",fO="qx.bom.client.Browser.getDocumentMode",fN="qx.allowUrlVariants",fT="qx.debug.ui.queue",fS="|",fR="qx.bom.client.Html.getContains",fQ="qx.bom.client.Plugin.getActiveX",fI=".",fH="qx.bom.client.Xml.getDomProperties",fG="qx.bom.client.CssAnimation.getSupport",fF="qx.debug.databinding",fM="qx.optimization.basecalls",fL="qx.bom.client.Browser.getVersion",fK="qx.bom.client.Css.getUserSelectNone",fJ="true",ga="qx.bom.client.Html.getSvg",fY="qx.bom.client.EcmaScript.getObjectKeys",fX="qx.bom.client.Plugin.getDivX",fW="qx.bom.client.Runtime.getName",ge="qx.bom.client.Html.getLocalStorage",gd="css.pointerevents",gc="qx.allowUrlSettings",gb="qx.bom.client.Flash.getStrictSecurityModel",fV="qx.aspects",fU="qx.debug",dR="qx.bom.client.Css.getPointerEvents",dQ="qx.dynamicmousewheel",gl="qx.bom.client.Html.getAudioMp3",dO="qx.bom.client.Engine.getName",dP="qx.bom.client.Html.getUserDataStorage",dN="qx.bom.client.Plugin.getGears",gj="qx.bom.client.Plugin.getQuicktimeVersion",dL="qx.bom.client.Html.getAudioOgg",dM="event.pointer",dK="qx.bom.client.Css.getTextShadow",gh="qx.bom.client.Plugin.getSilverlightVersion",dI="qx.bom.client.Html.getCompareDocumentPosition",dJ="qx.bom.client.Flash.getExpressInstall",dH="qx.bom.client.Html.getSelection",eb="qx.bom.client.OperatingSystem.getVersion",ec="qx.bom.client.Html.getXPath",dY="qx.bom.client.Html.getGeoLocation",ea="qx.optimization.privates",dW="qx.bom.client.Scroll.getNativeScroll",dX="qx.bom.client.Css.getAppearance",dV="qx.bom.client.CssTransition.getSupport",dG="qx.bom.client.Stylesheet.getAddImport",dT="qx.optimization.variants",dU="qx.bom.client.Html.getVideoWebm",dS="qx.bom.client.Flash.getVersion",ei="qx.bom.client.CssAnimation.getRequestAnimationFrame",eg="qx.bom.client.Css.getLegacyWebkitGradient",eh="qx.bom.client.PhoneGap.getNotification",ee="qx.bom.client.Html.getVideoH264",ef="qx.bom.client.Xml.getCreateElementNS",ed="qx.bom.client.Xml.getDomParser";qx.Bootstrap.define(gk,{statics:{_checks:{},_asyncChecks:{},__cache:{},_checksMap:{"engine.version":K,"engine.name":dO,"browser.name":eR,"browser.version":fL,"browser.documentmode":fO,"browser.quirksmode":fx,"runtime.name":fW,"device.name":y,"device.type":L,"device.pixelRatio":V,"device.touch":eP,"locale":ev,"locale.variant":eM,"os.name":eH,"os.version":eb,"os.scrollBarOverlayed":eC,"plugin.gears":dN,"plugin.activex":fQ,"plugin.skype":ex,"plugin.quicktime":M,"plugin.quicktime.version":gj,"plugin.windowsmedia":t,"plugin.windowsmedia.version":ej,"plugin.divx":fX,"plugin.divx.version":fe,"plugin.silverlight":X,"plugin.silverlight.version":gh,"plugin.flash":S,"plugin.flash.version":dS,"plugin.flash.express":dJ,"plugin.flash.strictsecurity":gb,"plugin.pdf":eT,"plugin.pdf.version":eD,"io.maxrequests":fg,"io.ssl":fA,"io.xhr":eA,"event.touch":z,"event.mspointer":fP,"event.help":eG,"event.hashchange":ff,"ecmascript.error.stacktrace":F,"ecmascript.array.indexof":fC,"ecmascript.array.lastindexof":k,"ecmascript.array.foreach":n,"ecmascript.array.filter":C,"ecmascript.array.map":eo,"ecmascript.array.some":fj,"ecmascript.array.every":H,"ecmascript.array.reduce":e,"ecmascript.array.reduceright":fu,"ecmascript.function.bind":fb,"ecmascript.object.keys":fY,"ecmascript.date.now":G,"ecmascript.error.toString":eB,"ecmascript.string.trim":D,"html.webworker":fz,"html.filereader":er,"html.geolocation":dY,"html.audio":fa,"html.audio.ogg":dL,"html.audio.mp3":gl,"html.audio.wav":eK,"html.audio.au":fr,"html.audio.aif":h,"html.video":x,"html.video.ogg":fw,"html.video.h264":ee,"html.video.webm":dU,"html.storage.local":ge,"html.storage.session":fs,"html.storage.userdata":dP,"html.classlist":eF,"html.xpath":ec,"html.xul":s,"html.canvas":T,"html.svg":ga,"html.vml":fh,"html.dataset":c,"html.dataurl":R,"html.console":J,"html.stylesheet.createstylesheet":en,"html.stylesheet.insertrule":b,"html.stylesheet.deleterule":et,"html.stylesheet.addimport":dG,"html.stylesheet.removeimport":p,"html.element.contains":fR,"html.element.compareDocumentPosition":dI,"html.element.textcontent":eW,"html.image.naturaldimensions":N,"html.history.state":fn,"html.selection":dH,"json":fy,"css.textoverflow":fD,"css.placeholder":gi,"css.borderradius":fk,"css.borderimage":es,"css.borderimage.standardsyntax":eE,"css.boxshadow":r,"css.gradient.linear":gf,"css.gradient.filter":fo,"css.gradient.radial":ep,"css.gradient.legacywebkit":eg,"css.boxmodel":W,"css.rgba":fm,"css.userselect":ek,"css.userselect.none":fK,"css.usermodify":q,"css.appearance":dX,"css.float":eX,"css.boxsizing":eN,"css.animation":fG,"css.animation.requestframe":ei,"css.transform":eV,"css.transform.3d":j,"css.transition":dV,"css.inlineblock":eS,"css.opacity":fq,"css.textShadow":dK,"css.textShadow.filter":fi,"css.alphaimageloaderneeded":ez,"css.pointerevents":dR,"phonegap":d,"phonegap.notification":eh,"xml.implementation":I,"xml.domparser":ed,"xml.selectsinglenode":a,"xml.selectnodes":O,"xml.getelementsbytagnamens":P,"xml.domproperties":fH,"xml.attributens":o,"xml.createnode":ey,"xml.getqualifieditem":fB,"xml.createelementns":ef,"qx.mobile.nativescroll":dW},get:function(gp){if(qx.Bootstrap.DEBUG){if(gp===dM){gp=gd;qx.Bootstrap.warn(gg+eU);}
;}
;if(qx.Bootstrap.DEBUG){if(gp===el){qx.Bootstrap.warn(w+fE);}
;}
;if(this.__cache[gp]!=undefined){return this.__cache[gp];}
;var gr=this._checks[gp];if(gr){var gn=gr();this.__cache[gp]=gn;return gn;}
;var gm=this._getClassNameFromEnvKey(gp);if(gm[0]!=undefined){var gq=gm[0];var go=gm[1];var gn=gq[go]();this.__cache[gp]=gn;return gn;}
;if(qx.Bootstrap.DEBUG){qx.Bootstrap.warn(gp+l+f);qx.Bootstrap.trace(this);}
;}
,_getClassNameFromEnvKey:function(gw){var gy=this._checksMap;if(gy[gw]!=undefined){var gt=gy[gw];var gx=gt.lastIndexOf(fI);if(gx>-1){var gv=gt.slice(0,gx);var gs=gt.slice(gx+1);var gu=qx.Bootstrap.getByName(gv);if(gu!=undefined){return [gu,gs];}
;}
;}
;return [undefined,undefined];}
,select:function(gA,gz){return this.__pickFromValues(this.get(gA),gz);}
,__pickFromValues:function(gE,gD){var gC=gD[gE];if(gD.hasOwnProperty(gE)){return gC;}
;for(var gF in gD){if(gF.indexOf(fS)!=-1){var gB=gF.split(fS);for(var i=0;i<gB.length;i++ ){if(gB[i]==gE){return gD[gF];}
;}
;}
;}
;if(gD[fc]!==undefined){return gD[fc];}
;if(qx.Bootstrap.DEBUG){throw new Error(eu+gE+eY+(typeof gE)+m+fd+qx.Bootstrap.keys(gD)+g);}
;}
,add:function(gH,gG){if(this._checks[gH]==undefined){if(gG instanceof Function){this._checks[gH]=gG;}
else {this._checks[gH]=this.__createCheck(gG);}
;}
;}
,addAsync:function(gJ,gI){if(this._checks[gJ]==undefined){this._asyncChecks[gJ]=gI;}
;}
,_initDefaultQxValues:function(){this.add(fJ,function(){return true;}
...
);this.add(fT,function(){return true;}
...
);this.add(eQ,function(){return false;}
);this.add(v,function(){return Y;}
);this.add(dQ,function(){return true;}
);this.add(fF,function(){return false;}
);this.add(fl,function(){return false;}
);this.add(fM,function(){return false;}
);this.add(eL,function(){return false;}
...
);this.add(em,function(){return true;}
);this.add(ew,function(){return true;}
);this.add(Q,function(){return false;}
);}
,__importFromGenerator:function(){if(qx&&qx.$$environment){for(var gK in qx.$$environment){var gL=qx.$$environment[gK];this._checks[gK]=this.__createCheck(gL);}
;}
;}
,__importFromUrl:function(){if(window.document&&window.document.location){var gM=window.document.location.search.slice(1).split(fv);for(var i=0;i<gM.length;i++ ){var gP=gM[i].split(u);if(gP.length!=3||gP[0]!=ft){continue;}
;var gN=gP[1];var gO=decodeURIComponent(gP[2]);if(gO==fJ){gO=true;}
else if(gO==fp){gO=false;}
else if(/^(\d|\.)+$/.test(gO)){gO=parseFloat(gO);}
;this._checks[gN]=this.__createCheck(gO);}
;}
;}
,__createCheck:function(gQ){return qx.Bootstrap.bind(function(gR){return gR;}
,null,gQ);}
},defer:function(gS){gS._initDefaultQxValues();gS.__importFromGenerator();if(gS.get(gc)===true){gS.__importFromUrl();}
;}
});}
)();
...
(function(){var a="qxWeb",b="qx-class";qx.Bootstrap.define(a,{extend:qx.type.BaseArray,statics:{__init:[],$$qx:qx,$init:function(g){var f=[];for(var i=0;i<g.length;i++ ){var d=!!(g[i]&&(g[i].nodeType===1||g[i].nodeType===9));if(d){f.push(g[i]);continue;}
;var c=!!(g[i]&&g[i].history&&g[i].location&&g[i].document);if(c){f.push(g[i]);}
;}
;var e=qxWeb;if(g[0]&&g[0].getAttribute&&g[0].getAttribute(b)){e=qx.Bootstrap.getByName(g[0].getAttribute(b))||e;}
...
;return qxWeb.$init(p);}
,members:{filter:function(r){if(qx.lang.Type.isFunction(r)){return qxWeb.$init(Array.prototype.filter.call(this,r));}
;return qxWeb.$init(qx.bom.Selector.matches(r,this));}
,unique:function(){var s=qx.lang.Array.unique(this);return qxWeb.$init(s,this.constructor);}
,slice:function(t,u){if(u!==undefined){return qxWeb.$init(Array.prototype.slice.call(this,t,u));}
;return qxWeb.$init(Array.prototype.slice.call(this,t));}
,splice:function(v,w,x){return qxWeb.$init(Array.prototype.splice.apply(this,arguments));}
,map:function(y,z){return qxWeb.$init(Array.prototype.map.apply(this,arguments));}
...
;}
;return qxWeb.$init(A);}
,_forEachElement:function(D,C){for(var i=0,l=this.length;i<l;i++ ){if(this[i]&&this[i].nodeType===1){D.apply(C||this,[this[i],i,this]);}
;}
;}
},defer:function(E){if(window.q==undefined){q=E;}
;}
});}
)();
...
(function(){var a="mshtml",b="engine.name",c="*",d="mouseover",e="mouseout",f="load",g="left",h="qx.module.Event",n="undefined",o="DOMContentLoaded",p="browser.documentmode",q="complete";qx.Bootstrap.define(h,{statics:{__normalizations:{},__hooks:{on:{},off:{}},on:function(A,v,w){for(var i=0;i<this.length;i++ ){var r=this[i];var s=w||qxWeb(r);var z=qx.module.Event.__hooks.on;var u=z[c]||[];if(z[A]){u=u.concat(z[A]);}
;for(var j=0,m=u.length;j<m;j++ ){u[j](r,A,v,w);}
;var t=function(event){var D=qx.module.Event.__normalizations;var C=D[c]||[];if(D[A]){C=C.concat(D[A]);}
;for(var x=0,y=C.length;x<y;x++ ){event=C[x](event,r,A);}
;v.apply(this,[event]);}
.bind(s);t.original=v;if(qx.bom.Event.supportsEvent(r,A)){qx.bom.Event.addNativeListener(r,A,t);}
;if(!r.__emitter){r.__emitter=new qx.event.Emitter();}
;var B=r.__emitter.on(A,t,s);if(!r.__listener){r.__listener={};}
;if(!r.__listener[A]){r.__listener[A]={};}
;r.__listener[A][B]=t;if(!w){if(!r.__ctx){r.__ctx={};}
;r.__ctx[B]=s;}
;}
;return this;}
,off:function(N,F,K){var J=(F===null&&K===null);for(var j=0;j<this.length;j++ ){var E=this[j];if(!E.__listener){continue;}
;var P=[];if(N!==null){P.push(N);}
else {for(var H in E.__listener){P.push(H);}
;}
;for(var i=0,l=P.length;i<l;i++ ){for(var I in E.__listener[P[i]]){var M=E.__listener[P[i]][I];if(J||M==F||M.original==F){var G=typeof E.__ctx!==n&&E.__ctx[I];var Q;if(!K&&G){Q=E.__ctx[I];}
;E.__emitter.off(P[i],M,Q||K);if(J||M.original==F){qx.bom.Event.removeNativeListener(E,P[i],M);}
;delete E.__listener[P[i]][I];if(G){delete E.__ctx[I];}
;}
;}
;var L=qx.module.Event.__hooks.off;var O=L[c]||[];if(L[N]){O=O.concat(L[N]);}
;for(var k=0,m=O.length;k<m;k++ ){O[k](E,N,F,K);}
;}
;}
;return this;}
,allOff:function(R){return this.off(R||null,null,null);}
,emit:function(S,T){for(var j=0;j<this.length;j++ ){var U=this[j];if(U.__emitter){U.__emitter.emit(S,T);}
;}
;return this;}
,once:function(W,V,Y){var self=this;var X=function(ba){self.off(W,X,Y);V.call(this,ba);}
;this.on(W,X,Y);return this;}
,hasListener:function(bb){if(!this[0]||!this[0].__emitter||!this[0].__emitter.getListeners()[bb]){return false;}
;return this[0].__emitter.getListeners()[bb].length>0;}
,copyEventsTo:function(bi){var bg=this.concat();var bh=bi.concat();for(var i=bg.length-1;i>=0;i-- ){var bd=bg[i].getElementsByTagName(c);for(var j=0;j<bd.length;j++ ){bg.push(bd[j]);}
;}
;for(var i=bh.length-1;i>=0;i-- ){var bd=bh[i].getElementsByTagName(c);for(var j=0;j<bd.length;j++ ){bh.push(bd[j]);}
;}
;bh.forEach(function(bj){bj.__emitter=null;}
);for(var i=0;i<bg.length;i++ ){var bc=bg[i];if(!bc.__emitter){continue;}
;var be=bc.__emitter.getListeners();for(var name in be){for(var j=be[name].length-1;j>=0;j-- ){var bf=be[name][j].listener;if(bf.original){bf=bf.original;}
;qxWeb(bh[i]).on(name,bf,be[name][j].ctx);}
;}
;}
;}
,__isReady:false,ready:function(bk){if(document.readyState===q){window.setTimeout(bk,1);return;}
;var bl=function(){qx.module.Event.__isReady=true;bk();}
;qxWeb(window).on(f,bl);var bm=function(){qxWeb(window).off(f,bl);bk();}
;if(qxWeb.env.get(b)!==a||qxWeb.env.get(p)>8){qx.bom.Event.addNativeListener(document,o,bm);}
else {var bn=function(){if(qx.module.Event.__isReady){return;}
;try{document.documentElement.doScroll(g);if(document.body){bm();}
;}
catch(bo){window.setTimeout(bn,100);}
;}
;bn();}
;}
,hover:function(bp,bq){var br;for(var j=0;j<this.length;j++ ){br=qxWeb(this[j]);br.on(d,bp,br);if(qx.lang.Type.isFunction(bq)){br.on(e,bq,br);}
;}
;return this;}
,$registerNormalization:function(bv,bs){if(!qx.lang.Type.isArray(bv)){bv=[bv];}
;var bt=qx.module.Event.__normalizations;for(var i=0,l=bv.length;i<l;i++ ){var bu=bv[i];if(qx.lang.Type.isFunction(bs)){if(!bt[bu]){bt[bu]=[];}
;bt[bu].push(bs);}
;}
;}
,$unregisterNormalization:function(bz,bw){if(!qx.lang.Type.isArray(bz)){bz=[bz];}
;var bx=qx.module.Event.__normalizations;for(var i=0,l=bz.length;i<l;i++ ){var by=bz[i];if(bx[by]){qx.lang.Array.remove(bx[by],bw);}
;}
;}
,$getRegistry:function(){return qx.module.Event.__normalizations;}
,$registerEventHook:function(bF,bC,bB){if(!qx.lang.Type.isArray(bF)){bF=[bF];}
;var bD=qx.module.Event.__hooks.on;for(var i=0,l=bF.length;i<l;i++ ){var bE=bF[i];if(qx.lang.Type.isFunction(bC)){if(!bD[bE]){bD[bE]=[];}
;bD[bE].push(bC);}
;}
;if(!bB){return;}
;var bA=qx.module.Event.__hooks.off;for(var i=0,l=bF.length;i<l;i++ ){var bE=bF[i];if(qx.lang.Type.isFunction(bB)){if(!bA[bE]){bA[bE]=[];}
;bA[bE].push(bB);}
;}
;}
,$unregisterEventHook:function(bL,bI,bH){if(!qx.lang.Type.isArray(bL)){bL=[bL];}
;var bJ=qx.module.Event.__hooks.on;for(var i=0,l=bL.length;i<l;i++ ){var bK=bL[i];if(bJ[bK]){qx.lang.Array.remove(bJ[bK],bI);}
;}
;if(!bH){return;}
;var bG=qx.module.Event.__hooks.off;for(var i=0,l=bL.length;i<l;i++ ){var bK=bL[i];if(bG[bK]){qx.lang.Array.remove(bG[bK],bH);}
;}
;}
,$getHookRegistry:function(){return qx.module.Event.__hooks;}
},defer:function(bM){qxWeb.$attach({"on":bM.on,"off":bM.off,"allOff":bM.allOff,"once":bM.once,"emit":bM.emit,"hasListener":bM.hasListener,"copyEventsTo":bM.copyEventsTo,"hover":bM.hover});qxWeb.$attachStatic({"ready":bM.ready,"$registerEventNormalization":bM.$registerNormalization,"$unregisterEventNormalization":bM.$unregisterNormalization,"$getEventNormalizationRegistry":bM.$getRegistry,"$registerEventHook":bM.$registerEventHook,"$unregisterEventHook":bM.$unregisterEventHook,"$getEventHookRegistry":bM.$getHookRegistry});}
});}
)();
